...
let modelURL = NSBundle.mainBundle().URLForResource("You_and_Me_List", withExtension: "momd")!
...
let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("You_and_Me_List.sqlite")
